...
const CAIApiList = ({ caiData, districtName, subDistrictName }) => {
    ...
    const filteredData = caiData.filter(item => item.stationName === districtName || item.stationName === subDistrictName);
    ...
    return (
        <div className=" overflow-y-auto p-4 bg-white rounded-lg shadow-md border border-gray-200">
            {filteredData.map((item, index) => (
                <div key={index} className="p-4 border border-gray-300 rounded-lg bg-gray-50 shadow-sm mb-4 flex">
