            ...
            <aside className='w-72'>
                    ...
                    <ul className='border'>
                        ...
                        >
                            ...
                            <li className='p-4 hover:bg-gray-200 text-slate-700 text-lg'>
                                ...
                                <a href="http://192.168.0.240:3000/rising">뜨는 업종</a>
                            </li>
                            <li className='p-4 hover:bg-gray-200 text-slate-700 text-lg'>
                ...
                <nav>
                    ...
                    <ul className='border'>
                        ...
                        >
                            <li className='p-4 hover:bg-gray-200 text-slate-700 text-lg'>
                                <a href="http://192.168.0.240:3000/commercial2">상권분석</a>
                            </li>
                            <li className='p-4 hover:bg-gray-200 text-slate-700 text-lg'>
                                <a href="http://192.168.0.239:3000/locInfo">입지정보</a>
                            </li>
                            <li className='p-4 hover:bg-gray-200 text-slate-700 text-lg'>
                                <a href="http://192.168.0.239:3000/locStore">매장정보</a>
                            </li>
                            <li className='p-4 hover:bg-gray-200 text-slate-700 text-lg'>
                                <a href="http://192.168.0.240:3000/rising">뜨는 업종</a>
                            </li>
                            <li className='p-4 hover:bg-gray-200 text-slate-700 text-lg'>
                                <a href="http://192.168.0.240:3000/location/context">지역 상황정보(날씨, 환경, 일출몰)</a>
                            </li>
                        </div>
                    </ul>
